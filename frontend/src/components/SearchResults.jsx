  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        exit={{ opacity: 0, y: -10 }}
        className="absolute top-full left-0 right-0 bg-white border border-gray-200 rounded-lg shadow-2xl z-50 mt-2 max-h-96 overflow-hidden"
      >
        {/* Header */}
        ...
        <div className="max-h-80 overflow-y-auto">
          {isSearching ? (
            ...
            <div className="py-8 text-center text-gray-500">
              <FaSearch className="mx-auto text-2xl mb-2 opacity-50" />
              <p className="text-sm">Search across all languages</p>
              <p className="text-xs mt-1">
