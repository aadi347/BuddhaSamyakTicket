...
const WeatherInfo = () => {
  return (
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-10 pb-10 border-b border-gray-700">
      ...
      <motion.div
        ...
        className=" text-white p-6 rounded-3xl shadow-xl space-y-4"
      >
...
>
  <div className="flex h-fit w-full items-center justify-center gap-[1em]">
    ...
    <span
      className="h-[4em] w-[1px] rounded-full bg-gray-500"
    ></span>
    <div className="flex flex-col items-start justify-center">
      <p className="text-[0.75rem] font-light">Seasoning City, Dishland</p>
      <p className="text-[1.5em] font-semibold">28°C</p>
      <div className="flex items-center justify-center gap-[0.125em]">
        ...
        <p className="text-[0.625rem] font-light">Don’t miss out the Rainbow</p>
      </div>
    </div>
  </div>
  ...
  <div className="flex h-fit w-full items-center justify-between">
    <div
      className="flex h-fit w-full flex-col items-start justify-between text-[0.75em]"
    >
      <div
        className="flex flex-row items-center justify-center gap-[0.5em] p-[0.25em]"
      >
        <svg
          viewBox="0 0 16 16"
          fill="none"
        ...
        <span
          className="h-[0.5em] w-[1px] rounded-full bg-gray-500"
        ></span>
        <p>Wind Speed</p>
        <span
          className="h-[0.5em] w-[1px] rounded-full bg-gray-500"
    ...
    <div
      className="flex h-full w-[6rem] flex-col items-center py-[0.25em] text-[0.625em]"
    >
      <div className="group relative z-0 h-[48px] w-[48px]">
        ...
        <span
          className="absolute bottom-[8px] left-1/2 z-[-1] h-[4px] w-[32px] -translate-x-1/2 bg-[#68082e] blur-[6px] duration-200 ease-linear group-hover:w-[16px] group-hover:blur-[4px]"
        ></span>
      </div>
      ...
      >
        ...
        <p className="text-white/80 text-xs leading-relaxed">
          The Buddha Samyak Darshan Museum is located in Vaishali — a region with rich
          heritage and dynamic weather. Stay informed about the current climate to plan
          your visit with ease and comfort. Whether it’s a sunny day or a gentle breeze, 
          experience culture with nature’s mood.
        </p>
      </motion.div>
